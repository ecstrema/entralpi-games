import { BbBluetooth } from "../shared/bluetooth.js";
...
var Game = {
  ...
  endGameMenu: function (text) {
    ...
    Pong.context.font = `${this.canvas.height / 20}px Courier New`;
  ...
  draw: function () {
    ...
    this.context.font = `${this.canvas.height / 10}px Courier New`;
    ...
    this.context.font = `${this.canvas.height / 33}px Courier New`;
    ...
    this.context.font = `${this.canvas.height / 25}px Courier New`;
